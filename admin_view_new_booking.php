    ...
    <!-- ######## Page  Title End ####### -->
      ...
      <div class="row contact-rooo no-margin">
        ...
        <div class="col-sm-12">
			...
			$qur1=mysqli_query($conn,"select * from booking_master where booking_status='0'");
			if(mysqli_num_rows($qur1)>0)
			{
				...
				while($q1=mysqli_fetch_array($qur1))
				{
					...
					echo "<td>$r2[1]</td>";
					echo "<td>$r2[4]</td>";
					echo "<td><a href='admin_update_booking_status.php?cbid=$q1[0]' class='btn btn-success'>CONFIRM</a></td>";
					echo "<td><a href='admin_view_new_booking.php?ncbid=$q1[0]' class='btn btn-danger'>NOT CONFIRM</a></td>";
					echo "</tr>";
				}
